                        ...
                        <div className="col-12">
                            <div className="row justify-content-center">
                                <div className="col-md-4" style={borderRight}>
                                    <h4 className="col-12 text-center"><strong>39</strong> </h4>
                                ...
                                <div className="col-md-4">
                                    ...
                                    <p className="col-12 text-center text-sm"> sq. Mile BattleField</p>
                                </div>
                                <Box m={6} />
                                <div>
                                <p className="col-12 text-center text-md">Bloody, confusing and wrought with incredible stories, the Russian Revolution created the first communist state on Earth. The Czecho-Slovak legion attempts to fights across the entirety of Russia circumnavigate the globe and get back home. Lenin and Trotsky surrounded in Moscow and St Petersburg fight their way to dominance. The inept Tsar finding a fate all too familiar for deposed autocrats. This is one of the most important moments in 20th century history. </p>
                                </div>
                            </div>
                        </div>
                    </div>
