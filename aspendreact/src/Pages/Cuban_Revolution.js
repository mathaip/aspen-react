                        ...
                        <div className="col-12">
                            <div className="row justify-content-center">
                                <div className="col-md-4" style={borderRight}>
                                    <h4 className="col-12 text-center"><strong>30</strong> </h4>
                                    <p className="col-12 text-center text-sm">Unique NFTS</p>
                                </div>
                                <div className="col-md-4" style={borderRight}>
                                    <h4 className="col-12 text-center">2 </h4>
                                    <p className="col-12 text-center text-sm">Revolutionary Icons</p>
                                </div>
                                <div className="col-md-4">
                                    <h4 className="col-12 text-center">1953 - 1959 </h4>
                                    <p className="col-12 text-center text-sm">The Years of the Revolution</p>
                                </div>
                                <Box m={6} />
                                <div>
                                <p className="col-12 text-center text-md">An American supporter dictator, 83 revolutionaries on the Granma and months in the Sierra Maestra. Fidel, Raul and Che up end the existing order long before they are known as communists. The defiant island nation that resisted an Empire began here.   </p>
                                </div>
                            </div>
                        </div>
                    </div>
