            ...
            <div className="row justify-content-center">
              ...
              <div>
                <p className="col-12 text-center text-md">
                  The first in our Philosopher series we present great thinkers
                  from across the planet. Featuring Voltaire, Kabir and Cho Je-u
                  this is the series for the lovers for philosophy out there.
                </p>
              </div>
            </div>
          </div>
