...
import product from '../images/frenchrevolution.png';
import { 
  MenuItem, 
  Select, 
  TextField,
                        ...
                        <div className="col-12">
                            <div className="row justify-content-center">
                                <div className="col-md-4" style={borderRight}>
                                    <h4 className="col-12 text-center"><strong>33</strong> </h4>
                                ...
                                <Box m={6} />
                                <div>
                                <p className="col-12 text-center text-md">Louis XVI, Maximilien Robespierre and Napoleon. The French Revolution is awash with monumental figures in history. Freedom, brutality and the eventual crowning of an Emperor, this period of history is awash with contradictions and imbued with importance in forming the modern nation-state. Liberté, Egalité, Fraternité </p>
                                </div>
                            </div>
                        </div>
                    </div>
