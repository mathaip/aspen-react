...
import product from '../images/taiping-rebellion.png';
import { 
  MenuItem, 
  Select, 
  TextField,
                        ...
                        <div className="col-12">
                            <div className="row justify-content-center">
                                <div className="col-md-4" style={borderRight}>
                                    <h4 className="col-12 text-center"><strong>29</strong> </h4>
                                ...
                                <div className="col-md-4">
                                    ...
                                    <p className="col-12 text-center text-sm">Birth of the <br></br> Heavenly Kingdom</p>
                                </div>
                                <Box m={6} />
                                <div>
                                <p className="col-12 text-center text-md">Hong Xiuquan, the rejected civil servant and self-proclaimed brother of Jesus Christ begins a rebellion, the advent of the Heavenly Kingdom. The bloodiest conflict of the 19th century claiming an estimated 45 million lives and stretching from the Yangzte River and flowing into Southeast Asia. The Taiping Heavenly Kingdom was one of the most deadly and repressive theocratic states in history.  </p>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default TaipingRebellionPack;